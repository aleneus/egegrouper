...
** TODO Tk views: Replace widgets to separate unit
** TODO Plot views: refactoring
** TODO BaseViews: fill all docstrings
** TODO Views: Inherit all views from base classes, total redesign of view part
...
* Proposal
** TODO Tk views: is the GroupingTable view?
